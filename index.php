...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Dirección: <?php echo $data['address']['city'];?></li>
  </ol>
</nav>
    ...
    <?php
    //json 
        $datal = json_decode(file_get_contents('https://jsonplaceholder.typicode.com/posts/1/comments/'),true);
        foreach ($datal as $i)
    {
    ?>
        <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action active">
                <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1"><?php echo "Comentario n." . $i['id'];?></h5>
